...
Quando o lead perguntar "o que é o Nola?", "o que vocês fazem?", "como funciona?" ou qualquer variação, use este bloco como base. Adapte ao tom da conversa mas SEMPRE inclua as palavras-chave.
...
"Feito, {{ $json.nome }}. Desculpa o incômodo e sucesso com o {{ $json.nome_negocio.split(' -')[0] }}. Se um dia precisar de algo, tô aqui. Abraço! :handshake:"
...
"{{ $json.nome }}, imagino que tá numa correria absurda. Vou parar de te mandar mensagem, mas se quiser trocar uma ideia sobre gestão, me chama. Tô aqui :handshake:"
...
"Fechado! [Dia] às [hora] :handshake: Vou te mandar o link do vídeo no dia. Se precisar remarcar, me avisa sem cerimônia. Até lá!"
...
```
:clipboard: RESUMO DE QUALIFICAÇÃO SDR
:convenience_store: Restaurante: {{ $json.nome_negocio.split(' -')[0] }}
:knife_fork_plate: Segmento: {{ $json.cuisine }}
:round_pushpin: Localização: {{ $json.address }}
:moneybag: Faixa de preço: {{ $json.priceRange }}
:star: Rating iFood: {{ $json.rating }}

:dart: BANT
:dollar: Budget: [status + evidência]
:bust_in_silhouette: Authority: [status + evidência]
:pushpin: Need: [dores identificadas]
:alarm_clock: Timeline: [urgência + evidência]

:thermometer: TEMPERATURA: [QUENTE / MORNO / FRIO]

:date: REUNIÃO
Data: [data] Hora: [hora] Formato: [vídeo] Duração: 40 min

:warning: ATENÇÃO PRO VENDEDOR
[Pontos relevantes]

:speaking_head_in_silhouette: FRASES DO LEAD
"[frases verbatim]"
```
